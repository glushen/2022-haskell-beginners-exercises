...
instance Semigroup Reward where
    ...
    (<>) x y =
        let
            gold = rewardGold x <> rewardGold y
            special = rewardSpecial x || rewardSpecial y
        in
            Reward gold special
...
No, because the neutral element of concatenation is empty list.
